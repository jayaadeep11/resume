...
%----------HEADING----------
\begin{center}
    \textbf{\Huge Jayadeep Bellamkonda} \\ \vspace{5pt}
    \small \faPhone* \texttt{+91 9705352421} \hspace{1pt} $|$
    \hspace{1pt} \faEnvelope \hspace{2pt} \texttt{jayadeep.bellamkonda@email.com} \hspace{1pt} $|$ 
    \hspace{1pt} \faLinkedin \hspace{2pt} {\href{https://www.linkedin.com/in/jayadeep-bellamkonda-053401259/}{\texttt {jayadeep}}} \hspace{1pt} $|$
    \hspace{1pt} \faGit* \hspace{2pt} {\href{https://www.github.com/jayaadeep11}{\texttt {jayaadeep11}}}
    \\ \vspace{-3pt}
\end{center}
...
\section {EDUCATION}
  \resumeSubHeadingListStart
    \resumeSubheading
      {Gayatri Vidya Parishad College of Engineering (Autonomous)(GVPCE)}{Aug. 2014 -- May 2018}
      {BTech in Information technology}{}
      \newline
      {CGPA: 7.70 (up to 5th sem)}{}
  \resumeSubHeadingListEnd

 \resumeSubHeadingListStart
    \resumeSubheading
      {Sir C.R.Reddy College of Engineering, Eluru }{Aug. 2014 -- May 2018}
      {May 2020 Percentage 12th: 7.77}{}
  \resumeSubHeadingListEnd
...
\section{PROJECTS}
    \resumeSubHeadingListStart
      \resumeProjectHeading
        ...
        \resumeProjectHeading
          {\textbf{Portfolio}}{Sept. 2020 -- Nov. 2020}
          \resumeItemListStart
            \resumeItem{Developed a self-designed personal portfolio showcasing some of my projects, resume, and technical skills.}
            \resumeItem{Implemented a fully responsive multi-page layout to ensure an optimal user experience across devices.}
            \resumeItem{Leveraged React.js, JavaScript, NPM packages, and hosted on Vercel for seamless deployment.}k
          \resumeItemListEnd
