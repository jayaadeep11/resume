...
\begin{center}
    \textbf{\Huge \scshape Jayadeep Bellamkonda} \\ \vspace{3pt}
    \small
    \faMobile \hspace{.5pt} \href{tel:905314204536}{+91 9705352421}
    $|$
    \faAt \hspace{.5pt} \href{mailto:jayadeep.bellamkonda@gmail.com}{jayadeep.bellamkonda@gmail.com}
    $|$
    \faLinkedinSquare \hspace{.5pt} \href{https://www.linkedin.com/in/jayadeep11}{LinkedIn}
    $|$
    \faGithub \hspace{.5pt} \href{https://github.com/jayadeep11}{GitHub}
    $|$
    \faGlobe \hspace{.5pt} \href{https://personal-site-ashy-sigma.vercel.app/}{Portfolio}
    $|$
...
\section{Education}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeEducationHeading
      ...
      }{Vishakapatnam, madhurawada}
      {B.Sc. in Information Technology;   \textbf{GPA: 3.62/4.00}}{Sep 2018 \textbf{--} Jun 2023}
     ...
     \resumeEducationHeading
      ...
      {computer science;   \textbf{GPA: 3.62/4.00}}{Sep 2018 \textbf{--} Jun 2023}
      {Minor Degree in Computer Science;
      \textbf{GPA: 3.58/4.00}}{Oct 2020 \textbf{--} Jun 2023}
